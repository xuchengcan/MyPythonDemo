...
def exec_360_jiagu():
    ...
    # 执行加固 jar 包命令，载入签名文件
    sign_cmd = 'java -jar jiagu.jar -importsign /Users/sunshine/signkey/xxx.keystore xxx xxx xxx'
    mulpkg_cmd = 'java -jar jiagu.jar -importmulpkg mulpkg.txt'  # 执行加固 jar 包命令，载入多渠道文件
    # 执行加固命令 apk 为 app-release.apk
    jiagu_cmd = 'java -jar jiagu.jar -jiagu app-release.apk /Users/sunshine/360jiagubao_mac/jiagu/output -autosign -automulpkg'
